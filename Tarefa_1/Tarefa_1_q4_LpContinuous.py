...
Caso particular para 4 DCs e 5 PTTs - LpContinuous
...
x_1_4=LpVariable("X_DC_1_PTT_4",0,None,LpContinuous)
x_1_5=LpVariable("X_DC_1_PTT_5",0,None,LpContinuous)
...
x_2_4=LpVariable("X_DC_2_PTT_4",0,None,LpContinuous)
x_2_5=LpVariable("X_DC_2_PTT_5",0,None,LpContinuous)

x_3_1=LpVariable("X_DC_3_PTT_1",0,None,LpContinuous)
x_3_2=LpVariable("X_DC_3_PTT_2",0,None,LpContinuous)
x_3_3=LpVariable("X_DC_3_PTT_3",0,None,LpContinuous)
x_3_4=LpVariable("X_DC_3_PTT_4",0,None,LpContinuous)
x_3_5=LpVariable("X_DC_3_PTT_5",0,None,LpContinuous)

x_4_1=LpVariable("X_DC_4_PTT_1",0,None,LpContinuous)
x_4_2=LpVariable("X_DC_4_PTT_2",0,None,LpContinuous)
x_4_3=LpVariable("X_DC_4_PTT_3",0,None,LpContinuous)
x_4_4=LpVariable("X_DC_4_PTT_4",0,None,LpContinuous)
x_4_5=LpVariable("X_DC_4_PTT_5",0,None,LpContinuous)
...
prob.writeLP("DC_PTT_q4_LpContinuous.lp")
